...
export const ShippingFormStripe: React.FC<ShippingFormStripeProps> = ({
  ...
  return (
    <div className="space-y-8">
      ...
      <header>
        <span className="text-xl font-bold text-negro">
          Shipping Information
        </span>
        <p className="text-sm text-gray-500 mt-1">
          We need your contact and address to ship your order and send tracking
          updates.
        </p>
      </header>
      ...
      <section aria-labelledby="contact-heading">
        <span
          id="contact-heading"
          className="text-sm font-semibold text-gray-800 mb-4 block"
        >
          Contact
        </span>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onShippingAddressChange({ email: e.target.value })
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onShippingAddressChange({ phone: e.target.value })
              }
      ...
      >
            ...
            <>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    onShippingAddressChange({ address: e.target.value })
                  }
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onShippingAddressChange({ city: e.target.value })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onShippingAddressChange({ state: e.target.value })
                    }
        ...
        {(() => {
          ...
          const addrErrors = [
            errors.shippingAddress.firstName && {
              field: "First name",
              msg: errors.shippingAddress.firstName,
            },
            errors.shippingAddress.lastName && {
              field: "Last name",
              msg: errors.shippingAddress.lastName,
            },
            errors.shippingAddress.address && {
              field: "Address line 1",
              msg: errors.shippingAddress.address,
            },
            errors.shippingAddress.city && {
              field: "City",
              msg: errors.shippingAddress.city,
            },
            errors.shippingAddress.state && {
              field: "State",
              msg: errors.shippingAddress.state,
            },
            errors.shippingAddress.zipCode && {
              field: "Postal code",
              msg: errors.shippingAddress.zipCode,
            },
            errors.shippingAddress.country && {
              field: "Country",
              msg: errors.shippingAddress.country,
            },
          ...
          const uniqueErrors = Array.from(byField.entries()).map(
            ([field, msgs]) => ({
              field,
              msg: msgs[0],
            }),
      ...
      <div className="pt-4 border-t border-gray-200">
        {stateRequiredForRates && !shippingAddress.state?.trim() ? (
          <p className="text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
            State / province is required to see shipping options for this
            country. Please complete the state field in the address above.
          </p>
          ...
          <>
            <span className="text-lg font-semibold text-negro mb-1 block">
              Shipping Method
            </span>
            {loading ? (
              ...
              <>
                <p className="text-sm text-gray-500 mb-4">
                  {ratesFromApi
                    ? "Shipping options for your address."
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="font-medium text-negro flex items-center gap-2">
                              {method.name}
                              {shippingMethods.length > 0 &&
                                shippingMethods[0].id === method.id && (
